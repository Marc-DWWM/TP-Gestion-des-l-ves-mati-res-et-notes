...
<body class="bg-gray-200 text-gray-800">
    ...
    <main class="flex flex-col items-center mt-8">
        ...
        <form action="traitementNote.php" method="POST" class="bg-white p-12 flex flex-col items-center justify-center">
            ...
            <div class="mb-4">
                <label for="id_etudiant" class="block text-sm font-medium text-gray-700 underline text-center">L'id de l'étudiant : </label>
            ...
            <div class="mb-4">
                <label for="id_matiere" class="block text-sm font-medium text-gray-700 underline text-center">L'id de la matière : </label>
            ...
            <div class="mb-4">
                <label for="valeurNote" class="block text-sm font-medium text-gray-700 underline text-center">La note de l'étudiant : </label>
